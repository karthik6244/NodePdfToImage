...
var accessKey = "Removing";
var storageAccount = "Removing";
...
module.exports = async function (context, myBlob) {
  try {
    ...
    // let rchar = '\';
    let sourceDirectory =
      dirName + "\\FileDownload\\" + context.bindingData.name;
    let targetDirectory =
      dirName + "\\targetimage\\" + context.bindingData.name;
